//Work IN Dev Sarthak Mittal=(Degamiesign)(16/04/2026#1.1/1,1.1.1.1
//Using JavaFX
...
public class MainApp extends Application {//inheriting Application
    public void existsBymodelRoot(ModelRoot modelRoot){if(modelRoot.isExists()!=null)getModelRoot(modelRoot);else getModelRoot(null);}//Checking ModelRoot's Existence in App
  ...
  public  Group mdl2=loadAICharacter(getClass().getResources("AI_CHARACTER.fbx"));//Mdl1 and 2 Obj declare
     ...
     public void setRoot1(Group root1){
       this.root1=root1;//Binding Root1 Node
     }
