//WID(05/04/2026)//DegamieSign(Sarthak Mittal)(#1.1).1.1.1.1.1C.1.1C
public class Ai_Character {
public String ainame=null;
public String getAiname(String ainame){return ainame;}//Fethcing AiNAme iN APP
    ...
    public KeyBoardInput updateByUserInp(KeyBoardInput userInp){getKeyBoardInput( userInp )+setKeyBoardInput( userInp )+1;}//Updating UserInp in App
    ...
    public Group loadAICharacter(URL url){//loadAICharacter funct Declare
        ...
        public Group getModelRoot(Group mdlRoot){return mdlRoot;}
